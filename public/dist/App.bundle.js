...
function loadPlaces(map) {
	...
	_axios2.default.get('/api/stores/near/v1?lat=' + lat + '&lng=' + lng).then(function (res) {
		var places = res.data;
		if (!places.length) {
		...
		// zoom the map to fit all of our markers perfectly
...
function typeAhead(search) {
	...
	searchInput.on('input', function () {
		...
		// if there is no value, hide the search results and return
		if (!this.value) {
